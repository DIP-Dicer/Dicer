...
BEGIN_MESSAGE_MAP(CDIPTeamProjectTeam5DicerDlg_Board, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CDIPTeamProjectTeam5DicerDlg_Board::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CDIPTeamProjectTeam5DicerDlg_Board::OnBnClickedButton2)
END_MESSAGE_MAP()

BOOL CDIPTeamProjectTeam5DicerDlg_Board::OnInitDialog()
{
	CDialogEx::OnInitDialog();
...
void CDIPTeamProjectTeam5DicerDlg_Board::OnPaint()
{
	if (IsIconic())
	{
		CPaintDC dc(this);
...
HCURSOR CDIPTeamProjectTeam5DicerDlg_Board::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CDIPTeamProjectTeam5DicerDlg_Board::OnBnClickedButton1() { // '주사위 굴리기' 버튼 클릭하면 red, blue, green 팀 순서대로 랜덤하게 주사위 이미지 띄움
...
String CDIPTeamProjectTeam5DicerDlg_Board::CurrentDiceTurn() { // 순서 바꾸기 (red/blue/green 순서대로, 잡으면 한 번 더)
...
String CDIPTeamProjectTeam5DicerDlg_Board::LoadDice() { // 난수 받아서 주사위 눈 1~6 결정
...
void CDIPTeamProjectTeam5DicerDlg_Board::CreateBitmapInfo(int width, int height) { // mat 이미지 별로 BITMAPINFO 구조체 생성
...
void CDIPTeamProjectTeam5DicerDlg_Board::DrawImage(int id, Mat m_matImage) { // 각 Picture control에 주사위와 보드 이미지 띄움
...
int CDIPTeamProjectTeam5DicerDlg_Board::GetCurrentTurn() {
...
void CDIPTeamProjectTeam5DicerDlg_Board::ChangeTurn(int nowTurn, int pos) {
	switch (nowTurn) {
	case 0:
		if (IsBlueCatch(pos) || IsGreenCatch(pos)) {
			turn = nowTurn;
...
void CDIPTeamProjectTeam5DicerDlg_Board::OnBnClickedButton2() { // '말 이동하기' 버튼 클릭하면 말 움직이는 함수 호출

	UpdateBoard(m_matImage2);
}

Mat CDIPTeamProjectTeam5DicerDlg_Board::Binarization(Mat m_matImage) { // 보드 이미지 이진화 시켜서 네모칸 식별하기 편하게
...
int CDIPTeamProjectTeam5DicerDlg_Board::RecognizeDiceNum(Mat m_matImage) { // 주사위 숫자 알아내기 (CalculatePosition 함수에서 호출됨)
...
int  CDIPTeamProjectTeam5DicerDlg_Board::CalculatePosition(int pos) { // 현재 위치와 주사위 숫자 이용해서 이동할 위치 계산 (UpdateBoard 함수에서 호출됨)
...
void CDIPTeamProjectTeam5DicerDlg_Board::DistributeCell(Mat m_matImage) { // 각 칸이 무슨 픽셀로 이루어져있는지 구분 (UpdateBoard 함수에서 사용)
...
char CDIPTeamProjectTeam5DicerDlg::BoardCellColor(int colornum) { // 칸을 나타내는 숫자가 어떤 색을 의미하는지 문자로 반환 (DistributeCell 함수에서 사용)
...
Mat CDIPTeamProjectTeam5DicerDlg_Board::ResizeMarker(int cellsize, Mat m_matImage) { // 말 이미지 크기를 보드 칸의 크기로 resize (UpdateBoard 함수에서 사용)
...
int CDIPTeamProjectTeam5DicerDlg_Board::GetPosition(int turn) {
	switch (turn) {
	case 0:
		return redPos;
	case 1:
...
// 잡았을 때 무슨 말이 잡혔습니다! 이런거 나오면 좋을 듯.
bool CDIPTeamProjectTeam5DicerDlg_Board::IsRedCatch(int pos) {
	if (redPos == pos) {
		redPos = 0;
		return true;
	}
...
bool CDIPTeamProjectTeam5DicerDlg_Board::IsBlueCatch(int pos) {
	if (bluePos == pos) {
		bluePos = 0;
		return true;
	}
...
bool CDIPTeamProjectTeam5DicerDlg_Board::IsGreenCatch(int pos) {
	if (greenPos == pos) {
		greenPos = 0;
		return true;
	}
...
void CDIPTeamProjectTeam5DicerDlg_Board::UpdateBoard(Mat m_matImage) { // 이동할 위치를 받아와서 보드에 적용시킴 (Button2를 클릭하면 호출됨)
...
BEGIN_MESSAGE_MAP(DIPTeamProject_Team5DicerDlg_Board, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON4, &DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton4)
	ON_BN_CLICKED(IDC_BUTTON5, &DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton5)
	ON_BN_CLICKED(IDC_BUTTON6, &DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton6)
	ON_BN_CLICKED(IDC_BUTTON7, &DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton7)
END_MESSAGE_MAP()
...
void DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton4()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton5()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton6()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void DIPTeamProject_Team5DicerDlg_Board::OnBnClickedButton7()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}*/